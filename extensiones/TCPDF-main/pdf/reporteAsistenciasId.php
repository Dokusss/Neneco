...
// Obtener el parámetro del URL
$idEmpleado = $_GET['idEmpleado'];

// Validar que el idEmpleado no esté vacío
if (empty($idEmpleado)) {
    die("Error: El ID del empleado no debe estar vacío. Por favor, verifique la información proporcionada.");
}

// Llamar al método para obtener los datos de asistencias
$respuesta = ModeloAsistencia::mdlImprimirReporteAsistenciasId($idEmpleado);
...
$html .= '<p style="text-align:center;">ID del Empleado: ' . $idEmpleado . '</p>';

// Información del empleado en formato horizontal
$html .= '<table border="0" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px; margin-bottom: 10px;">';
$html .= '<tr>
...
// Generar el contenido del reporte con la cabecera de la tabla en color gris claro
