            ...
            <form role="form" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="editarHoraInicio" class="form-control" data-toggle="input-mask"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="editarHoraFin" class="form-control" data-toggle="input-mask"
                            data-mask-format="00:00:00" maxlength="8" placeholder="HH:MM:SS" required>
                    </div>
